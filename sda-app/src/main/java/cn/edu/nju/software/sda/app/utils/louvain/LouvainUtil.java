package cn.edu.nju.software.sda.app.utils.louvain;
...
public class LouvainUtil {
    private static void writeOutputJson(String fileName, Louvain a) throws IOException {
    ...
    private static void writeOutputCluster(String fileName, Louvain a) throws IOException{
        BufferedWriter bufferedWriter;
        bufferedWriter = new BufferedWriter(new FileWriter(fileName));
        for(int i=0;i<a.global_n;i++){
    ...
    private static void writeOutputCircle(String fileName, Louvain a) throws IOException{
        BufferedWriter bufferedWriter;
        bufferedWriter = new BufferedWriter(new FileWriter(fileName));
    ...
    public static void execute(String inputPath,String outputPath) throws IOException {
...
//        writeOutputCircle("/Users/yzgqy/Desktop/circle.txt",a);   //打印每个簇有哪些节点
        writeOutputCircle(outputPath,a);
